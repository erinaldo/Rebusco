...
Public Class ReporteStockPOS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MarketONE.ReporteStockPOS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteStockPOS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteStockPOS = New ReporteStockPOS()
        rpt.Site = Me.Site
        Return rpt
    End Function
