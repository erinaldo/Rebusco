    ...
    Public Class CommonDrawing
        ...
        Public Shared Sub DrawSelection(ByVal g As Graphics, _
            ...
            DrawSelection(g, _
                          ...
                          colorTable.SelectedGradientBottom, _
                          colorTable.SelectedBorder, _
                          rect, _
                          rounded)
        End Sub

        Public Shared Sub DrawSelection(ByVal g As Graphics, _
                                        ByVal gradientTop As Color, _
                                        ByVal gradientBottom As Color, _
            ...
            ' Bottom
            Using b As New SolidBrush(bottom)
